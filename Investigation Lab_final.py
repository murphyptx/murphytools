...
def file_reputation_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("file reputation", parameters=parameters, assets=['virustotal'], callback=Hash_List_Check, name="file_reputation_1")
...
def pin_5(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    results_data_1 = phantom.collect2(container=container, datapath=['{geolocate_ip_1:action_result.data.*.country_name} is not a threat'], action_results=results)
    results_data_2 = phantom.collect2(container=container, datapath=['geolocate_ip_1:action_result.data.*.country_name'], action_results=results)

    results_item_1_0 = [item[0] for item in results_data_1]
    results_item_2_0 = [item[0] for item in results_data_2]

    phantom.pin(container=container, data=results_item_2_0, message=results_item_1_0, pin_type="card", pin_style="blue", name=None)
...
def Hash_List_Check(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    phantom.debug('Hash_List_Check() called')
